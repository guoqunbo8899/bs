    ...
    <div class="dingdanqianshou-detail" v-loading="loading" ref="print">
        ...
        <div class="admin-detail">
            ...
            <div class="detail detail-textarea">
                <div class="detail-title">签收备注：</div>
                <div class="detail-content">{{ map.qianshoubeizhu }}</div>
            </div>
            <div class="detail detail-textuser">
                <div class="detail-title">签收用户：</div>
                <div class="detail-content">{{ map.qianshouyonghu }}</div>
            </div>
            ...
            <div class="detail detail-dataset">
                ...
                <div class="detail-content">
                    <e-dataset-table table="dingdanqianshoudingdanshangpin" :where="{ dingdanqianshouid : $route.query.id  }" order="id desc" var="dataSets">
