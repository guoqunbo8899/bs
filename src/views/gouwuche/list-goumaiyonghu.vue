    ...
    <div class="v-list" v-loading="loading" element-loading-text="加载中">
        <el-card class="box-card">
            ...
            <el-table border :data="list" style="width: 100%" highlight-current-row>
                ...
                <el-table-column label="购买用户" width="80">
                    <template slot-scope="{row}"> {{ row.goumaiyonghu }} </template>
                </el-table-column>
            ...
            <div>小计总和: {{ total.sum_xiaoji }}
                <el-button type="danger" @click="$goto('/admin/dingdanxinxiadd?sum_xiaoji='+total.sum_xiaoji)">生成订单</el-button>
            </div>
        </el-card>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            ...
            loadList(page) {
                ...
                this.$post(api.gouwuche.listgoumaiyonghu, filter)
                    .then((res) => {
                        this.loading = false;
