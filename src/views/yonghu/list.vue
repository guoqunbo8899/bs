        ...
        <el-card class="box-card">
            ...
            <el-table border :data="list" style="width: 100%" highlight-current-row>
                ...
                <el-table-column label="密码">
                    <template slot-scope="{row}"> {{ row.mima }} </template>
                </el-table-column>
                ...
                <el-table-column label="家庭地址" width="130">
                    <template slot-scope="{row}"> {{ row.jiatingdizhi }} </template>
                </el-table-column>
                <el-table-column label="身份证" width="130">
                    <template slot-scope="{row}"> {{ row.shenfenzheng }} </template>
                </el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            loadList(page) {
                ...
                this.$post(api.yonghu.list, filter)
                    .then((res) => {
                        this.loading = false;
