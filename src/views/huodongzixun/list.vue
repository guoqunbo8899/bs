                    ...
                    <template slot-scope="{row}">
                        <el-button-group>
                            <el-tooltip content="回复" placement="top">
                                <el-button icon="el-icon-edit" @click="$goto({path:'/admin/huodongzixunupdt',query:{id:row.id } })" v-if="row.zhuangtai == '待回复'"  type="warning" size="mini"></el-button>
                            </el-tooltip>
                            <el-tooltip content="详情" placement="top">
                                <el-button @click="$goto({path:'/admin/huodongzixundetail',query:{id:row.id } })" icon="el-icon-info" type="info" size="mini"></el-button>
                            </el-tooltip>
    ...
    export default {
        ...
        methods: {
            ...
            loadList(page) {
                ...
                this.$post(api.huodongzixun.list, filter)
                    .then((res) => {
                        this.loading = false;
            ...
            deleteItem(row) {
                this.$confirm("确定删除数据？", "提示", {
                    ...
                    .then(() => {
                        ...
                        this.$post(api.huodongzixun.delete, {
                            // 提交后台
                            id: row.id,
                        })
                            .then((res) => {
