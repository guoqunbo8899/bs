        ...
        <el-card class="box-card">
            ...
            <el-table border :data="list" style="width: 100%" highlight-current-row>
                ...
                <el-table-column label="网站名称" width="130">
                    <template slot-scope="{row}"> {{ row.wangzhanmingcheng }} </template>
                </el-table-column>
                    ...
                    <template slot-scope="{row}">
                        <el-button-group>
                            <el-tooltip content="编辑" placement="top">
                                <el-button icon="el-icon-edit" @click="$goto({path:'/admin/youqinglianjieupdt',query:{id:row.id } })" type="warning" size="mini"></el-button>
                            </el-tooltip>
