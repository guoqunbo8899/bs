<template>
    <div class="lvyouhuodong-detail" v-loading="loading" ref="print">
        ...
        <div class="admin-detail">
            ...
            <div class="detail detail-select">
                <div class="detail-title">活动状态：</div>
                <div class="detail-content">{{ map.huodongzhuangtai }}</div>
            </div>
            ...
            <div class="detail detail-number">
                <div class="detail-title">参与人数：</div>
                <div class="detail-content">{{ map.canyurenshu }}</div>
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            loadDetail() {
                ...
                this.loading = true;
                this.$get(api.lvyouhuodong.detail, {
                    id: this.id,
                })
                    .then((res) => {
                        this.loading = false;
