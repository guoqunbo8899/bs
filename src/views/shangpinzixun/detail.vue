<template>
    <div class="shangpinzixun-detail" v-loading="loading" ref="print">
        ...
        <div class="admin-detail">
            ...
            <div class="detail detail-select">
                <div class="detail-title">咨询状态：</div>
                <div class="detail-content">{{ map.zixunzhuangtai }}</div>
            </div>
            <div class="detail detail-money">
                <div class="detail-title">商品价格：</div>
                <div class="detail-content">{{ map.shangpinjiage }}</div>
            </div>
            <div class="detail detail-textarea">
                <div class="detail-title">咨询内容：</div>
                <div class="detail-content">{{ map.zixunneirong }}</div>
            </div>
            <div class="detail detail-textarea">
                <div class="detail-title">咨询回复：</div>
                <div class="detail-content">{{ map.zixunhuifu }}</div>
            </div>
            <div class="detail detail-textuser">
                <div class="detail-title">咨询用户：</div>
                <div class="detail-content">{{ map.zixunyonghu }}</div>
            </div>
            <div class="detail detail-autotime">
                <div class="detail-title">咨询时间：</div>
                <div class="detail-content">{{ map.addtime }}</div>
            </div>
            <div class="detail detail-images">
                <div class="detail-title">商品图片：</div>
                <div class="detail-content">
                    <e-images :src="map.shangpintupian" type="detail"></e-images>
                </div>
            </div>
        </div>
        <div class="mt10">
    ...
    export default {
        ...
        methods: {
            ...
            loadDetail() {
                ...
                this.loading = true;
                this.$get(api.shangpinzixun.detail, {
                    id: this.id,
                })
                    .then((res) => {
                        this.loading = false;
