            ...
            <div class="header-top clearfix">
                ...
                <div class="right">
                    <template v-if="$session.username">
                        <el-dropdown>
                            <span class="el-dropdown-link"> {{ $session.username }} <i class="el-icon-arrow-down el-icon--right"></i> </span>
                    ...
                    <template v-else>
                        <el-button type="primary" @click="$router.push('/login')" size="mini"> 登录 </el-button>
                    </template>
                </div>
            </div>
        </e-container>
            ...
            <e-container class="clearfix">
                ...
                <div class="header-nav-ul nav-left clearfix">
                    <ul class="header-nav-left clearfix">
                        ...
                        <li>
                            <router-link to="/gudongxinxi">古董展示 </router-link>
                        </li>
                        <li>
                            <router-link to="/lvyouhuodong">文化旅游活动 </router-link>
                        </li>
                        <li>
                            <router-link to="/shangpinxinxi">商品信息 </router-link>
                        </li>
                        <li>
                            <router-link to="/yonghuadd">在线注册 </router-link>
                        </li>
                    </ul>
                </div>
                <div class="nav-right">
                    <el-input v-model="keyword" placeholder="输入搜索古董名称关键词" @keyup.enter="searchKeyword">
...
<script>
    ...
    export default {
        ...
        methods: {
            searchKeyword() {
                var filter = {};
                filter["gudongmingcheng"] = this.keyword;
                this.$router.push({
                    path: "/gudongxinxi",
                    query: filter,
                });
