            ...
            <el-table border :data="list" style="width: 100%" highlight-current-row>
                ...
                <el-table-column label="操作">
                    <template slot-scope="{row}">
                        <el-button-group>
                            <el-button @click="$goto('/admin/dingdanfahuoadd?id='+row.id)"v-if="row.dingdanzhuangtai == '待发货'" type="success"
                                       icon="el-icon-plus" size="mini"> 发货
                            </el-button>
    ...
    export default {
        ...
        methods: {
            ...
            loadList(page) {
                ...
                this.$post(api.dingdanxinxi.list, filter)
                    .then((res) => {
                        this.loading = false;
            ...
            deleteItem(row) {
                this.$confirm("确定删除数据？", "提示", {
                    ...
                    .then(() => {
                        ...
                        this.$post(api.dingdanxinxi.delete, {
                            // 提交后台
                            id: row.id,
                        })
                            .then((res) => {
