<template>
    <div class="dingdanfahuo-detail" v-loading="loading" ref="print">
        <el-page-header @back="goBack" content="详情页面"></el-page-header>
        <div class="admin-detail">
            <div class="detail detail-readmodule">
                <div class="detail-title">订单信息id：</div>
                <div class="detail-content">{{ map.dingdanxinxiid }}</div>
            </div>
            ...
            <div class="detail detail-text">
                <div class="detail-title">物流公司：</div>
                <div class="detail-content">{{ map.wuliugongsi }}</div>
            </div>
            ...
            <div class="detail detail-textuser">
                <div class="detail-title">下单用户：</div>
                <div class="detail-content">{{ map.xiadanyonghu }}</div>
            </div>
            <div class="detail detail-longtext">
                <div class="detail-title">物流单号：</div>
                <div class="detail-content">{{ map.wuliudanhao }}</div>
            </div>
            ...
            <div class="detail detail-dataset">
                <div class="detail-title">订单商品：</div>
                <div class="detail-content">
                    <e-dataset-table table="dingdanfahuodingdanshangpin" :where="{ dingdanfahuoid : $route.query.id  }" order="id desc" var="dataSets">
    ...
    export default {
        ...
        methods: {
            ...
            loadDetail() {
                ...
                this.loading = true;
                this.$get(api.dingdanfahuo.detail, {
                    id: this.id,
                })
                    .then((res) => {
                        this.loading = false;
