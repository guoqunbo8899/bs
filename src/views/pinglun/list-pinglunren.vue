        ...
        <el-card class="box-card">
            ...
            <el-table border :data="list" style="width: 100%" highlight-current-row>
                ...
                <el-table-column label="评论内容">
                    <template slot-scope="{row}"> {{ row.pinglunneirong }} </template>
                </el-table-column>
                <el-table-column label="评论人" width="80">
                    <template slot-scope="{row}"> {{ row.pinglunren }} </template>
                </el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            loadList(page) {
                ...
                this.$post(api.pinglun.listpinglunren, filter)
                    .then((res) => {
                        this.loading = false;
