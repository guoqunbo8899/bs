    ...
    <div class="shangpinxinxi-detail" v-loading="loading" ref="print">
        ...
        <div class="admin-detail">
            ...
            <div class="detail detail-number">
                <div class="detail-title">商品销量：</div>
                <div class="detail-content">{{ map.shangpinxiaoliang }}</div>
            </div>
            <div class="detail detail-number">
                <div class="detail-title">点击量：</div>
                <div class="detail-content">{{ map.dianjiliang }}</div>
            </div>
            <div class="detail detail-spec">
                <div class="detail-title">商品型号：</div>
                <div class="detail-content">{{ map.shangpinxinghao }}</div>
            </div>
            <div class="detail detail-spec">
                <div class="detail-title">商品颜色：</div>
                <div class="detail-content">{{ map.shangpinyanse }}</div>
            </div>
            <div class="detail detail-video">
                <div class="detail-title">商品视频：</div>
                <div class="detail-content">
