                                ...
                                <table class="jd-search">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <el-input type="text" style="width: 150px" v-model="search.shangpinmingcheng" placeholder="请输入关键词"> </el-input>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td></td>
        ...
        data() {
            return {
                ...
                search: {
                    ...
                    shangpinxiaoliang_start: "",
                    shangpinxiaoliang_end: "",
